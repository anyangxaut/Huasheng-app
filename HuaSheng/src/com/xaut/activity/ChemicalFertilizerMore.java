...
public class ChemicalFertilizerMore extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.chemical_fertilizer_more);
	 ...
	 public void shownews(int i){
			...
			intent.setClass(ChemicalFertilizerMore.this, ShowNews.class);
