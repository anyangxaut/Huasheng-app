...
public class GasHistory extends BaseActivity{
...
public void month(){
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		menu.add(groupId, 2, menuItemOrder, "温度").setIcon(R.drawable.icon);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case 0: {
			...
			intent.setClass(GasHistory.this, FirstPage.class);
			startActivity(intent);
			break;
		}
		case 1: {
			Intent intent = new Intent();
			intent.setClass(GasHistory.this, Qtkshow.class);
			startActivity(intent);
			break;
		}
		case 2: {
			Intent intent = new Intent();
			intent.setClass(GasHistory.this, QtkHistory.class);
			startActivity(intent);
			break;
		}
		case 3: {
			Intent intent = new Intent();
			intent.setClass(GasHistory.this, HumidityHistory.class);
			startActivity(intent);
			break;
		}
		default:
