...
public class Humidity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mRenderer.setChartTitle("气调库" + storenum + "湿度变化图");// 设置图表标题
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case 0:{
  			...
  			intent.setClass(Humidity.this, FirstPage.class);
  			startActivity(intent);	
  			break;
  		}
  		case 1:{
  			Intent intent=new Intent();
  			intent.setClass(Humidity.this, Chart.class);
  			startActivity(intent);	
  			break;
  		}
		case 2: {
			Intent intent = new Intent();
			intent.setClass(Humidity.this, ChartShow.class);
		...
		case 3: {
			Intent intent = new Intent();
			intent.setClass(Humidity.this, Gas.class);
			Bundle bundle=new Bundle();
			bundle.putInt("storenum", storenum);
			intent.putExtras(bundle);
			startActivity(intent);
