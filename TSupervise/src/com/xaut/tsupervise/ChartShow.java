...
public class ChartShow extends BaseActivity {
	...
	private int count, addx, flag, storenum;
	private String url;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		title1 = "气调库温度变化图T1" + " (单位：℃)";
		title2 = "气调库温度变化图T2" + " (单位：℃)";
		...
		mRenderer.setChartTitle("气调库" + storenum + "温度变化图");// 设置图表标题
	...
	//温度更新
		private void updatetemperature() {
			...
			NameValuePair pair2 = new BasicNameValuePair("storenum", String.valueOf(storenum));
			List<NameValuePair> pairList = new ArrayList<NameValuePair>();
			pairList.add(pair1);
			pairList.add(pair2);

			url = httpUtil.BASE_URL + "/ChartServlet";
	...
	private void getdata() {
	   ...
	   @Override
	  	public boolean onCreateOptionsMenu(Menu menu) {
	  		...
	  		menu.add(groupId, 1, menuItemOrder, "实时曲线首页").setIcon(R.drawable.icon);
	  		menu.add(groupId, 2, menuItemOrder, "湿度变化图").setIcon(R.drawable.icon);
			menu.add(groupId, 3, menuItemOrder, "氧气，二氧化碳变化图").setIcon(R.drawable.icon);
	  	...
	  	public boolean onOptionsItemSelected(MenuItem item) {
	  		...
	  		case 0:{
	  			...
	  			intent.setClass(ChartShow.this, FirstPage.class);
	  			startActivity(intent);	
	  			break;
	  		}
	  		case 1:{
	  			Intent intent=new Intent();
	  			intent.setClass(ChartShow.this, Chart.class);
	  			startActivity(intent);	
	  			break;
	  		}
	  		case 2: {
				Intent intent = new Intent();
				intent.setClass(ChartShow.this, Humidity.class);
			...
			case 3: {
				Intent intent = new Intent();
				intent.setClass(ChartShow.this, Gas.class);
				Bundle bundle=new Bundle();
				bundle.putInt("storenum", storenum);
				intent.putExtras(bundle);
				startActivity(intent);
