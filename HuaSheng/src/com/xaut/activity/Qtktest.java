...
public class Qtktest extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_qtktest);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case 0: {
			...
			intent.setClass(Qtktest.this, FirstPage.class);
		...
		case 1: {
			Intent intent = new Intent();
			intent.setClass(Qtktest.this, Qtkshow.class);
			startActivity(intent);
			timer.cancel();
			break;
		}
		case 2: {
			Intent intent = new Intent();
			intent.setClass(Qtktest.this, Humidity.class);
			startActivity(intent);
			timer.cancel();
			break;
		}
		case 3: {
			Intent intent = new Intent();
			intent.setClass(Qtktest.this, Gas.class);
			startActivity(intent);
			timer.cancel();
			break;
		}
